        ...
        <Background>
            ...
            {!isHeaderOpen ?
                <Container>
                    ...
                    <Box>
                        <TextDescription>Experienced UX Designer with over ten years of expertise, based in Yerevan, Armenia. Specializing on complicated systems and huge data.</TextDescription>
                    </Box>
                    <Box>
                        <TextTitled>Currently Senior UX<br/> Designer at ISAA.</TextTitled>
                    </Box>
                    <Box>
                        <Socials />
                    </Box>
